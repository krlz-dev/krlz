...
export default function ContactSection() {
  return (
    <section className="py-24 max-md:py-16 border-t border-border" id="contact">
      <Container>
        <ScrollReveal>
          <div className="text-center max-w-[600px] mx-auto">
            <SectionLabel text="04 / Contact" centered />
            <h2 className="font-display text-[clamp(2.5rem,6vw,4rem)] font-bold tracking-[-0.03em] leading-none mb-6">
